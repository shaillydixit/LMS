                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="logo-box logo--box">
                            <a href="{{route('dashboard')}}" class="logo"><img src="{{asset('frontend/assets/images/logo.png')}}" alt="logo"></a>
                                                ...
                                                <ul class="cart-dropdown-menu after-none">
                                                    <li class="media media-card">
                                                        <a href="lesson-details.html" class="media-img">
                                                            <img class="mr-3" src="{{asset('frontend/assets/images/small-img-3.jpg')}}"
                                                    ...
                                                    <li class="media media-card">
                                                        <a href="lesson-details.html" class="media-img">
                                                            <img class="mr-3" src="{{asset('frontend/assets/images/small-img-4.jpg')}}"
                                                                alt="Course thumbnail image">
                                                        </a>
                                                        <div class="media-body">
                                                            <h5><a href="lesson-details.html">The Complete
                                                    ...
                                                    <li>
                                                        <a href="my-courses.html" class="btn theme-btn w-100">Got to
                                                            my course <i class="la la-arrow-right icon ml-1"></i></a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                                ...
                                                <ul class="cart-dropdown-menu after-none">
                                                    <li class="media media-card">
                                                        <a href="shopping-cart.html" class="media-img">
                                                            <img class="mr-3" src="{{asset('frontend/assets/images/small-img.jpg')}}"
                                                                alt="Cart image">
                                                        </a>
                                                        <div class="media-body">
                                                ...
                                                <div class="shop-cart-btn">
                                                    <div class="avatar-xs">
                                                        <img class="rounded-full img-fluid"
                                                            src="{{asset('frontend/assets/images/small-avatar-1.jpg')}}" alt="Avatar image">
                                                    </div>
                                                    <span class="dot-status bg-1"></span>
                                                </div>
                                                @php
                                                ...
                                                <ul
                                                    ...
                                                    <li>
                                                        <ul class="generic-list-item">
                                                            ...
                                                            <li><a href="{{ route('user.change.password') }}"> <i class="la la-edit mr-1"></i>Change Password </a></li>
                                                            <li>
