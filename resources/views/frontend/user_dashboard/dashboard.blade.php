...
<body>
    ...
    @include('frontend.user_dashboard.body.header')<!-- end header-menu-area -->
    <!--======================================
        END HEADER AREA
======================================-->
        ...
        <div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
            ...
            <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
                ...
                <li><a href="dashboard-withdraw.html"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px"
                            ...
                            <circle cx="16" cy="12" r="1.5" /></svg> Withdraw</a></li>
                ...
                <li><a href="dashboard-submit-course.html"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg"
                            height="18px" viewBox="0 0 24 24" width="18px">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z" /></svg> Submit Course</a></li>
                ...
                <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between mb-5">
                    <div class="media media-card align-items-center">
                        <div class="media-img media--img media-img-md rounded-full">
                            <img class="rounded-full"  src="{{ (!empty($profileData->photo)) ? url('/storage/files/user/'.$profileData->photo) : url('upload/no_image.jpg')}}" alt="Student thumbnail image">
                        </div>
